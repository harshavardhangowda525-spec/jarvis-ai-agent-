...
function explainReg(res) {
  ...
  return {
    "ok": "✓ Connected. JARVIS, EV and DARWIN use this PC's brain as their unlimited backup when the cloud is rate-limited\n    (or first, if you chose \"Your PC (Ollama) first\" in Settings → AI).",
